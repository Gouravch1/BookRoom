      ...
      <nav className="border-b border-stone-200 bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-6 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="text-sm bg-stone-900 text-white px-4 py-1.5 rounded-md hover:bg-stone-800 transition-colors font-medium"
      ...
      <main className="flex-1">
        <div className="max-w-5xl mx-auto px-6 py-20 sm:py-28">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-semibold text-stone-900 leading-tight tracking-tight mb-5">
              Your personal<br />
              <span className="text-stone-500">reading library.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/register"
                className="bg-stone-900 text-white px-6 py-2.5 rounded-md hover:bg-stone-800 transition-colors text-sm font-medium"
              >
                Start reading for free
              </Link>
              <Link
                href="/login"
                className="border border-stone-200 text-stone-700 px-6 py-2.5 rounded-md hover:bg-stone-100 transition-colors text-sm font-medium"
              >
                Sign in
              </Link>
            </div>
